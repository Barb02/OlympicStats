...
st.write('Using the sidebar on the left (or the ">" symbol if you are on mobile), you can pick an edition from the \'Editions\' section to view individual medal stats for that year by country, or you can head over to the \'Olympics Through the Years\' section to compare multiple editions.')
